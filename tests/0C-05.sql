...
INSERT INTO users 
	...
	VALUES
	(50001, 'Lina', 'Kuhn', 2903011202, 105841301),
	(50002, 'Hans', 'Muller', 3548684134, 1300965829),
	(50003, 'Jan', 'Jager', 661493766, -820579705),
	(50004, 'Clara', 'Wolff', 2268503768, 570753184),
	(50005, 'Gustav', 'Schafer', 1807260148, -613448384),
...
INSERT INTO members 
	...
	(20010, 'Erich', 'Kramer', 1880227642, -1084383144);

INSERT INTO users 
	(id, name, surname, codeA, codeB)
	VALUES
	(50011, 'Finn', 'Schumacher', 386109874, 1391356532),
	(50012, 'Luca', 'Schafer', 1465251768, -729839515),
	(50013, 'Nils', 'Wagner', 802064166, 21468263),
	(50014, 'Kathe', 'Kuhn', 1595237720, 1051177379),
	...
	(50019, 'Andre', 'Kramer', 2276498702, 48300072),
